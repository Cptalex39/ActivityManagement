...
export class ServizioForms {
  ...
  getCampiNuovoServizio(item, handleOnChange, handleOnClick, handleOnBlur) {
    return {
      ...
      name: ["nome", "tipologia_servizio", "prezzo", "descrizione", "note"],
      id: ["nuovo_nome_servizio", "nuovo_tipologia_servizio", "nuovo_prezzo_servizio", "nuova_descrizione_servizio", "nuove_note_servizio"],
      value: [item.nome, item.tipologia_servizio, item.prezzo, item.descrizione, item.note],
      placeholder: [
        this.lingua === "italiano" ? "Nome*" : "Name*",
      ...
      errore: [item.errore_nome, item.errore_tipologia_servizio, item.errore_prezzo, item.errore_descrizione, item.errore_note],
