...
export class PagamentoActions extends Actions {
  ...
  /**
   * Azione per annullare ed eliminare un pagamento in sospeso.
   * 
   * @param {number} idPagamento - id del pagamento da annullare ed eliminare. 
   */
  async annullaPagamentoInSospeso(idPagamento) {
    console.log("ID Pagamento:")
    console.log(idPagamento);
  }
}
